...
<body>
    <section id="about me">
        <nav>
            <div class="personal_logo"> J-DE§IGN§</div>
<ul class="nav__link--list">
    <li>
        <a href="" class="
        nav__link--anchor 
        link__hover-effect
link__hover--black">languages</a>
    </li>
...
nav__link--anchor-primary">contact</a>
      ...
      <div class="about-me__info row">
        <div class="about-me__info--container">
          ...
          <h1 class="about-me__info--title">
            Hey! I'm <span class="text--green">Johns Portfolio</span>&nbsp;<span class="wave">👋</span>
          </h1>
          <p class="about-me__info--para">
            I'm a <strong class="text--green"> future frontend software engineer</strong> with a passion for building
            apps and websites
          </p>
  ...
  <section id="languages">
    <div class="container">
      <div class="row">
        <h1 class="section__title">This Are <span class="text--green">My Stacks</span></h1>
          ...
          <li class="project">
            <div class="project__wrapper">
              ...
              <div class="project__description">
                <h3 class="project__description--title">shirt sales project</h3>
                <h4 class="project__description--sub-title">
                  Html, CSS, JavaScript,
                </h4>
                <p class="project__description--para">
this was my second project trying to build a shirt sales website. I used vanilla javascript for the interactivity and css grid
                  for the layout. I learned a lot about javascript and css while building this project.
                </p>
  ...
  <footer>
    <div class="row footer__row">
      ...
      <div class="footer__copyright">Copyright © 2021 David Bragg</div>
    </div>
  </footer>
</body>
